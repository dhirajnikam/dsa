...
# Binary search how many elements of the shorter array belong to the left half so that
# every left element <= every right element; the median then reads off the partition edges.
